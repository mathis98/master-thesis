...
class FullPipeline(pl.LightningModule):
	...
	def test_step(self, batch, batch_idx):
		...
		self.test_recall_1.append(recall_1)
		self.test_recall_5.append(recall_5)
		self.test_recall_10.append(recall_10)
		self.test_recall_20.append(recall_20)
	...
	def on_test_epoch_end(self):
		...
		avg_recall_1 = np.mean(np.concatenate(self.test_recall_1))
		avg_recall_5 = np.mean(np.concatenate(self.test_recall_5))
		avg_recall_10 = np.mean(np.concatenate(self.test_recall_10))
		avg_recall_20 = np.mean(np.concatenate(self.test_recall_20))
		...
		self.log('Recall@1', avg_recall_1, batch_size=self.batch_size, prog_bar=True, sync_dist=True)
		self.log('Recall@5', avg_recall_1, batch_size=self.batch_size, prog_bar=True, sync_dist=True)
		self.log('Recall@10', avg_recall_1, batch_size=self.batch_size, prog_bar=True, sync_dist=True)
		self.log('Recall@20', avg_recall_1, batch_size=self.batch_size, prog_bar=True, sync_dist=True)
