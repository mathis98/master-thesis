...
if intra == True:
	...
	image_data_module = ImageDataModule('../Datasets/UCM/imgs', (224,224), batch_size, 5, technique='Repeat')
	image_data_module.prepare_data()
	image_data_module.setup(stage='predict')


	text_data_module = SentenceDataModule('prajjwal1/bert-small', batch_size, '../Datasets/UCM/dataset.json', 5, technique='Repeat')
	text_data_module.prepare_data()
